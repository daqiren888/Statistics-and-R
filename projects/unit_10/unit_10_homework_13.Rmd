...
ggplot(results_house, aes(x= general_votes)) +
...
ggplot(results_house, aes(x= general_votes)) +
    scale_x_log10(breaks = trans_breaks("log", function(x) 10^x),
        labels = trans_format("log", math_format(10^.x))) +
    scale_y_log10(breaks = trans_breaks("log", function(x) 10^x),
        labels = trans_format("log", math_format(10^.x))) +
    geom_histogram(aes(y=..density..), colour="black", fill="white")+
    geom_density(alpha=.2, fill="#FF6666")
