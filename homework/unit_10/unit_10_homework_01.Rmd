...
my_summary <- campaigns %>%
  count(cand_id, sort = TRUE) 
...
#p<-ggplot(results_house, aes(y= general_percent)) +
#   geom_histogram(color="black", fill="white")
#
# # Add mean line
# p+ geom_vline(aes(xintercept=mean( general_percent)),
...
# p+ geom_vline(aes(xintercept=mean(ttl_disb)),
#             color="blue", linetype="dashed", size=1)
# Histogram with density plot
...
#
# campaigns %>%
#   ggplot(aes(x = campaigns$ttl_disb)) +
# #  geom_histogram(binwidth = 1, fill="white", position = "identity")+
#   geom_histogram(binwidth = 1, aes(color= "red"), fill="white", position = "identity")+
